			...
			?>
				...
				enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input value="<?php echo $row['title'];?>" onblur="hideError(this)" id="title" type="text" name="title" class="form-control">
					</div>
					
					<div class="form-group">
						<label>Enter Description *  <span class="text-danger" id="desc_err"></span></label>
						<textarea onblur="hideError(this)" id="desc" name="description" class="form-control" style="height:150px;"><?php echo $row['description']?></textarea>
					</div>
