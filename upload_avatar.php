		...
		if(isset($_POST['register']))
		{
			...
			if(in_array($type,$allowed_type))
			{
										...
										"avatars/$fname"))
				{
					...
					{
						setcookie('msg',"File Uploaded Successfully",time()+3);
						header('Location:upload_avatar.php');	
					}
					else
					{
						setcookie('msg',"Sorry! Unable to Upload",time()+3);
						header('Location:upload_avatar.php');
					}
			...
			{
				setcookie('msg',"Please Upload a valid Image",time()+3);
				header('Location:upload_avatar.php');
			}
		}
		?>
		...
		enctype="multipart/form-data">
			<table class='table'>
				...
				<tr>
					...
					name="register" value="Upload" class='btn btn-primary'></td>
				</tr>
			</table>
		</form>
		</div>
