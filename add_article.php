			...
			<p class="text-danger">All * fields are mandatory </p>
				...
				enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input onblur="hideError(this)" id="title" type="text" name="title" class="form-control" placeholder="Enter Article Title">
					</div>
					
					<div class="form-group">
						<label>Enter Description *  <span class="text-danger" id="desc_err"></span></label>
						<textarea onblur="hideError(this)" id="desc" name="description" class="form-control" style="height:150px;" placeholder="Enter Description"></textarea>
					</div>
